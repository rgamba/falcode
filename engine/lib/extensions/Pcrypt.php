...
class Pcrypt
{
    ...
    function Pcrypt($blockmode = MODE_ECB, $cipher = 'BLOWFISH', $key = null)
    {
        ...
        $cipher = ucwords($cipher);
		/*
        if (!file_exists("includes/cipher/".$cipher.".php")&&!file_exists("../includes/cipher/".$cipher.".php")) 
        {
            $this->error("Unknown Cipher ".$cipher);
        }
		if(file_exists("includes/cipher/".$cipher.".php")){
        	include_once "includes/cipher/".$cipher.".php";
        }else{
			//include_once "../includes/cipher/".$cipher.".php";
			if(file_exists("/var/www/vhosts/cobrando.com.mx/httpsdocs/includes/cipher/".$cipher.".php")){
				include_once("/var/www/vhosts/cobrando.com.mx/httpsdocs/includes/cipher/".$cipher.".php");
			}else{
				include_once("../includes/cipher/".$cipher.".php");
			}
		}
